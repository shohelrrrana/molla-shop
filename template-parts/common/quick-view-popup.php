<?php
/**
 * The template for quick view popup
 *
 * @package molla-shop
 * */
        ...
        <div class="quickView-content">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6">
                    ...
                    <p class="product-txt">Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus
                        metus
                        libero eu augue.</p>
                    ...
                    <div class="details-filter-row product-nav product-nav-thumbs">
                        ...
                        <a href="#" class="active">
                            <img src="https://portotheme.com/html/molla/assets/images/demos/demo-6/products/product-1-thumb.jpg"
                                 alt="product desc">
                        </a>
                        <a href="#">
                            <img src="https://portotheme.com/html/molla/assets/images/demos/demo-6/products/product-1-2-thumb.jpg"
                                 alt="product desc">
                        </a>
                    </div><!-- End .product-nav -->
